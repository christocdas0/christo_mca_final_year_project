...
import {
  ...
  TableHeader,
  HeaderContainer,
} from "../styles/editAttendance";
import { ArrowBack } from "@mui/icons-material";
import { useNavigate } from "react-router-dom";
import { useDispatch, useSelector } from "react-redux";
import { getAttendance, editAttendance } from "../redux/thunk/mainThunk";
...
const EditAttendance = () => {
  ...
  const handleBack = () => {
    ...
    dispatch(setGoBack({ isFrom: "editAttendance" }));
  };
        ...
        <>
          <LeftSection>
            <HeaderContainer>
              ...
              <Header variant="h5">Edit Attendance</Header>
            </HeaderContainer>
